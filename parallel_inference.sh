...
do
    echo $split_idx
    brain task create -p 76 --cmd "python main_woong.py --config_file configs/${YAML_NAME} --exp_name ${EXP_NAME} --inference --split_idx ${split_idx} --n_split ${N_SPLIT} --epoch ${EPOCH}  --num_workers 6"\
